          ...
          <div className="ai-brief mt-16 p-8 bg-emerald-950 rounded-3xl border border-gold/20 relative overflow-hidden shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
               <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-bold text-gold uppercase tracking-[0.4em]">Generation Brief (AI Ready)</span>
               </div>
               <button 
    ...
    <div className="max-w-6xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="flex items-end justify-between border-b border-black/5 pb-8">
         <div className="space-y-1">
            <h2 className="text-4xl font-serif text-emerald-950">Maison Photoshoot Director</h2>
            <p className="text-[10px] text-emerald-950/40 font-bold uppercase tracking-[0.4em]">Human Planning & Neural Synthesis Orchestration.</p>
         </div>
      </div>
           ...
           <div className="bg-white rounded-4xl p-10 border border-emerald-50 soft-shadow space-y-10">
              <div className="space-y-6">
                 <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold text-emerald-950/40 uppercase tracking-widest">01. Production Asset</span>
                 ...
                 >
                    {productImage ? (
                      ...
                      <div className="text-center space-y-2">
                        ...
                        <span className="text-[9px] font-bold text-emerald-950/20 uppercase tracking-widest block">Upload Reference</span>
                      </div>
                    )}
              ...
              <div className="space-y-6 pt-10 border-t border-emerald-50">
                 <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold text-emerald-950/40 uppercase tracking-widest">02. Creative Directive</span>
                 ...
                 />
                 <p className="text-[8px] text-emerald-950/30 uppercase font-bold tracking-widest text-center">Director is ready for your vision</p>
              </div>
              ...
              >
                {isGenerating ? 'Directing Photoshoot...' : 'Direct Photoshoot'}
              </button>
           </div>
        </div>
           ...
           {briefText ? (
              <div className="bg-[#FCFAF8] rounded-4xl p-16 border border-emerald-50 soft-shadow relative animate-in fade-in zoom-in-95 duration-500 min-h-[600px] flex flex-col">
                 ...
                 <div className="flex items-center justify-between mb-12 border-b border-gold/10 pb-8 relative z-10">
                    <div className="space-y-1">
                       <span className="text-[10px] font-bold text-gold uppercase tracking-[0.5em]">Director's Production Suite</span>
                       <h3 className="text-3xl font-serif text-emerald-950 italic">Project Orchestration</h3>
                    </div>
                 ...
                 <div className="mt-20 pt-12 border-t border-gold/10 text-center relative z-10">
                    <div className="inline-flex items-center gap-4 px-6 py-2 bg-white rounded-full border border-emerald-50">
                       ...
                       <span className="text-[9px] font-bold text-emerald-950/40 uppercase tracking-[0.3em]">Authorized by AMRAH Neural Core</span>
                    </div>
                 </div>
              </div>
           ) : isGenerating ? (
              <div className="h-[600px] bg-white rounded-4xl border border-emerald-50 flex flex-col items-center justify-center space-y-8 animate-in fade-in duration-500">
                 ...
                 <div className="text-center space-y-2">
                    <p className="text-[12px] font-bold uppercase text-gold tracking-[0.5em] animate-pulse">Consulting with Visual Director</p>
              ...
              <div className="h-[400px] bg-red-50 rounded-4xl border border-red-100 flex flex-col items-center justify-center space-y-4 text-center p-12">
                 ...
                 <h4 className="text-xl font-serif text-red-950">Director Intervention</h4>
              ...
              <div className="h-[600px] bg-white rounded-4xl border border-emerald-50 border-dashed flex flex-col items-center justify-center space-y-6 text-center p-20 animate-in fade-in duration-1000">
                 ...
                 <div className="space-y-4">
                    <h4 className="text-2xl font-serif text-emerald-950">Director's Chair is Empty.</h4>
                    <p className="text-sm text-emerald-950/40 max-w-md font-light leading-relaxed">Submit your reference and vision to receive a comprehensive human production plan and an AI-ready generation brief.</p>
                 </div>
              </div>
           )}
        </div>
